...
server.get("/hello", (req, res) => {
    res.json({ hello: "future senior developer" });
});
...
server.delete("/api/channels/:id", (req, res) => {
    ...
    if (deleted) {
        ...
        res.status(404).json({
            message: "Channel you are looking is not found",
        });
    }
});
...
server.delete("/api/lessons/:id", (req, res) => {
    ...
    if (deleted) {
        ...
        res.status(404).json({
            message: "Lesson you are looking is not found",
        });
    }
});
...
server.get("/api/channels/:id", (req, res) => {
    ...
    if (found) {
        ...
        res.status(404).json({ message: "Channel does not exit" });
    }
});
